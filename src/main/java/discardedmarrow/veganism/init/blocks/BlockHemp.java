...
public class BlockHemp extends Block implements net.minecraftforge.common.IPlantable
{
    ...
    {
        if (worldIn.getBlockState(pos.down()).getBlock() == BlockSpecialInit.hemp_crop || this.checkForDrop(worldIn, pos, state))
        {
    ...
    {
        return new ItemStack(ItemInit.hemp);
    }
