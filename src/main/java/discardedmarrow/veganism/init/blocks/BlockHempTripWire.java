...
public class BlockHempTripWire extends Block
{
    ...
    public BlockHempTripWire(String name)
    {
    ...
    {
        return ItemInit.hemp_string;
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ItemInit.hemp_string);
    }
    ...
    private void notifyHook(World worldIn, BlockPos pos, IBlockState state)
    {
        for (EnumFacing enumfacing : new EnumFacing[] {EnumFacing.SOUTH, EnumFacing.WEST})
        {
            for (int i = 1; i < 42; ++i)
            {
                ...
                if (iblockstate.getBlock() != BlockSpecialInit.hemp_tripwire)
                {
                    break;
                }
            }
    ...
    public static boolean isConnectedTo(IBlockAccess worldIn, BlockPos pos, IBlockState state, EnumFacing direction)
    {
        ...
        {
            return block == BlockSpecialInit.hemp_tripwire;
        }
    }
